...
function updateVars(component) {
  console.group('updating variables')
  const variables = Array.from(
    component.shadowRoot.querySelectorAll('.variable'),
  )
  console.log(variables, component.shadowRoot.querySelector('b'), component.title)
  ...
  console.groupEnd('updating variables')
}
...
function onDomReady(initFn) {
  return new Promise(resolve => {
    console.log('prepared to resolve', document.readyState)
